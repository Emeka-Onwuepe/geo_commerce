...
const getsales = (e) => {
    e.preventDefault()
    const cluster = getSalesForm.elements.cluster.value
    ...
    if (start_date === "" && end_date === "") {
        ...
        if (start_date == end_date) {
            window.location.href = `/sales/analysis/${cluster}/${start_date}`
        } else {
            window.location.href = `/sales/${start_date}/${end_date}/${cluster}/rangeanalysis`
        }
    }
}
